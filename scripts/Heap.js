...
function swap(i,j)
{
    ...
    div_update(divs[i],div_sizes[i],"brown");//Color update
    div_update(divs[j],div_sizes[j],"brown");//Color update
}
...
function max_heapify(n,i)
{
    ...
    if(l<n && div_sizes[l]>div_sizes[largest])
    {
        if(largest!=i)
        {
            div_update(divs[largest],div_sizes[largest],"brown");//Color update
        }
