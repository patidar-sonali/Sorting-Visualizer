...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"yellow");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(divs[i],div_sizes[i],"brown");//Height update
                div_update(divs[j],div_sizes[j],"brown");//Height update
    ...
    div_update(divs[start],div_sizes[start],"blue");//Height update
    div_update(divs[i-1],div_sizes[i-1],"blue");//Height update
